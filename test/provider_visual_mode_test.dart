...
const _openCodeQuota = ProviderQuota(
  ...
  windows: [
    ProviderQuotaWindow(label: '5 小时周期', remainingPercent: 80, resetAt: null),
    ProviderQuotaWindow(label: '本周额度', remainingPercent: 60, resetAt: null),
    ProviderQuotaWindow(label: '本月额度', remainingPercent: 40, resetAt: null),
  ],
);
...
void main() {
  ...
  testWidgets(
    'provider energy core stacks orb and quota bays on narrow screens',
    (tester) async {
